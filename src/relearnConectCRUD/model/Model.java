...
public class Model<T extends Entity<?>> implements ModelDAO{
    ...
    public static PreparedStatement getKey(String query) throws SQLException {
        pstm = openConnection().prepareStatement(query,PreparedStatement.RETURN_GENERATED_KEYS);
        return pstm;
    }
